# Identity\-based policy examples for Amazon ElastiCache<a name="security_iam_id-based-policy-examples"></a>
...
## Using the ElastiCache console<a name="security_iam_id-based-policy-examples-console"></a>
...
To ensure that users and roles can still use the ElastiCache console, also attach the ElastiCache `ConsoleAccess` or `ReadOnly` AWS managed policy to the entities\. For more information, see [Adding permissions to a user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_change-permissions.html#users_change_permissions-add-console) in the *IAM User Guide*\.
