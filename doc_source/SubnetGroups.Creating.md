...
![\[Image: Create Subnet VPC screen\]](http://docs.aws.amazon.com/AmazonElastiCache/latest/UserGuide/images/vpc-03.png)
...
For more information, see the AWS CLI topic [create\-cache\-subnet\-group](http://docs.aws.amazon.com/cli/latest/reference/elasticache/create-cache-subnet-group.html)\.
