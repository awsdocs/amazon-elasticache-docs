...
+ [Getting started with Amazon ElastiCache for Redis](GettingStarted.md)
   ...
   + [Step 1: Create a cluster](GettingStarted.CreateCluster.md)
      + [Create a cluster mode disabled cluster](GettingStarted.CreateClusterModeDisabled.md)
      + [Create a cluster mode enabled cluster](GettingStarted.CreateClusterEnabled.md)
