...
For more information on this process, see [Creating a Redis \(cluster mode disabled\) cluster \(Console\)](GettingStarted.CreateCluster.md#Clusters.Create.CON.Redis-gs)\. Be sure to have one or more replicas and enable Multi\-AZ\.
