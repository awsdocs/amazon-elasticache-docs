...
For more information, see the AWS CLI topic [modify\-cache\-subnet\-group](http://docs.aws.amazon.com/cli/latest/reference/elasticache/modify-cache-subnet-group.html)\.
